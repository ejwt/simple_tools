...
do
    ...
    mv ${FILE} ${year}-${str_month}-${str_day}_${str_hour}${str_minute}${str_second}.jpg
done
...
do
    ...
    mv ${FILE} ${year}-${str_month}-${str_day}_${str_hour}${str_minute}${str_second}.png
done
...
do
    ...
    mv ${FILE} ${year}-${str_month}-${str_day}_${str_hour}${str_minute}${str_second}.gif
done

# ========================== mmexport*.webp ==========================
ls *.webp > filenames.tmp
...
do
    ...
    mv ${FILE} ${year}-${str_month}-${str_day}_${str_hour}${str_minute}${str_second}.webp
done
...
do
    ...
    mv ${FILE} ${year}-${str_month}-${str_day}_${str_hour}${str_minute}${str_second}.mp4
done
...
for FILE in `cat filenames.tmp | grep wx_camera_`
do
    unix_time=`echo ${FILE} | cut -c 11-23`
    echo 'Unix time: '${unix_time}
